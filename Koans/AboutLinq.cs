...
namespace DotNetCoreKoans.Koans
{
    ...
    {
        /*
         *LINQ (Language Integrated Query). LINQ provides language-level
         * querying capabilities and a higher-order function API to C# and VB as
         * a way to write expressive, declarative code. All LINQ query
        ...
        {
            //This sample uses "where" to find all elements of an array less
            //than 5.
